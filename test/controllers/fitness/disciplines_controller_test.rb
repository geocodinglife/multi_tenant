...
class Fitness::DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fitness_discipline" do
    assert_difference('Fitness::Discipline.count') do
      post fitness_disciplines_url, params: { fitness_discipline: { enable: @fitness_discipline.enable, name: @fitness_discipline.name } }
    end
  ...
  test "should update fitness_discipline" do
    patch fitness_discipline_url(@fitness_discipline), params: { fitness_discipline: { enable: @fitness_discipline.enable, name: @fitness_discipline.name } }
